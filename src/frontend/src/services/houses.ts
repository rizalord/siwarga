...
export const housesService = {
  ...
  getById: (id: number) => api.get<ApiResponse<House>>(`/api/houses/${id}`),
  ...
  delete: (id: number) => api.delete<ApiResponse<null>>(`/api/houses/${id}`),
  restore: (id: number) =>
    api.post<ApiResponse<House>>(`/api/houses/${id}/restore`),
  forceDelete: (id: number) =>
    api.delete<ApiResponse<null>>(`/api/houses/${id}/force-delete`),
  bulkDelete: (ids: number[]) =>
    api.post<ApiResponse<null>>('/api/houses/bulk-delete', { ids }),
  bulkRestore: (ids: number[]) =>
    api.post<ApiResponse<null>>('/api/houses/bulk-restore', { ids }),
  bulkForceDelete: (ids: number[]) =>
    api.post<ApiResponse<null>>('/api/houses/bulk-force-delete', { ids }),
  ...
  assignResident: (id: number, data: AssignResidentRequest) =>
    api.post<ApiResponse<HouseResident>>(
      `/api/houses/${id}/assign-resident`,
      data
    ),
