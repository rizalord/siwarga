...
export function DataTableBulkActions<TData>({
  ...
  useEffect(() => {
    if (selectedCount > 0) {
      const message = `${selectedCount} ${entityName} dipilih. Toolbar aksi massal tersedia.`
  ...
  return (
    <>
      ...
      <div
        ref={toolbarRef}
        role='toolbar'
        aria-label={`Aksi massal untuk ${selectedCount} ${entityName} yang dipilih`}
